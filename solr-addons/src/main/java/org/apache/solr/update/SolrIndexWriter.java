...
public class SolrIndexWriter extends IndexWriter {
  ...
  public static Directory getDirectory(String path, DirectoryFactory directoryFactory, SolrIndexConfig config) throws IOException {
    ...
    System.out.println("------------------------------------------------------------------------------");
    System.out.println("HACKING SOLR ^_^");
    System.out.println("------------------------------------------------------------------------------");
    if(d instanceof InfinispanDirectory){
    	// do nothing we have already set the lock factory
    	 System.out.println("enjoy :-)");
    }else if ("simple".equals(lockType)) {
    ...
    } else if ("custom".equals(lockType)) {
      // do nothing, keep the current lock  
    }else {
